...
;(function() {
  ...
  function runInContext(context) {
    ...
    var _ = context && context._ || require('benchmark/api/lodash') || root._;
    if (!_) {
    ...
    _.assign(Benchmark, {
       ...
       * @type Object
       */
      'platform': context.platform || require('benchmark/api/platform') || ({
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['benchmark/api/lodash', 'benchmark/api/platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
